...
一个适用于各类 AI Agent 的通用 Skill，通过高德地图 Web 服务 API 实现关键字搜索 POI（兴趣点）功能。

> 💬 对 AI Agent 说「帮我搜一下北京的火锅店」即可触发搜索。
...
2. 在你使用的 AI Agent 中导入 Skill zip 包即可

### 方式二：手动安装

将 `gaode-poi-search/` 目录复制到你所使用的 AI Agent 的 Skills 目录下即可。

## 💬 使用方式

在 AI Agent 对话中直接用自然语言描述你想搜索的地点：
